...
/**
 * ChatView — componente de chat reutilizable por todos los sub-roles.
 *
 * Encapsula toda la lógica de sesión, historial y envío de mensajes,
 * exponiendo únicamente la prop `sessionPrefix` para namespacing en
 * sessionStorage y `accentColor` para personalización visual por rol.
 */
...
interface ChatViewProps {
  ...
  /** Color de acento para el badge de estado (CSS color string) */
  accentColor?: string;
}
    ...
    <div className="flex flex-col max-w-3xl mx-auto" style={{ height: "calc(100vh - 64px)" }}>
      ...
      <div className="flex items-center gap-3 mb-4">
        <div
          ...
          style={{ background: `linear-gradient(135deg,${accentColor},#764ba2)` }}
        >
        ...
        <div>
          ...
          <span
            ...
            style={{
              background: badgeActive ? "rgba(52,211,153,0.15)" : "rgba(255,255,255,0.08)",
              color:      badgeActive ? "#34d399"               : "rgba(255,255,255,0.4)",
              border:     badgeActive
          ...
          >
            <span
              ...
              style={{ background: badgeActive ? "#34d399" : "rgba(255,255,255,0.3)" }}
            />
            {badgeText}
          </span>
        </div>
        ...
        {mensajes.length === 0 ? (
          <div className="flex flex-col items-center justify-center h-full gap-4 py-12">
            <div
              ...
              style={{ background: `linear-gradient(135deg,${accentColor},#764ba2)`, opacity: 0.7 }}
            >
      ...
      {error && (
        <p className="text-sm mt-2 px-1" style={{ color: "#f87171" }}>
          {error}
        </p>
      )}
