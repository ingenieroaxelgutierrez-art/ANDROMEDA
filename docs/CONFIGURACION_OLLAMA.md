# Configuración de Ollama - Límite de RAM 2GB

## 🎯 Objetivo
Limitar el uso de RAM de Ollama a aproximadamente **2GB máximo** para evitar problemas de rendimiento en el sistema.
