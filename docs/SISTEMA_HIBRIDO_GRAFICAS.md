# SISTEMA HÍBRIDO DE GRÁFICAS — ANDROMEDA v9.0

## Descripción

Sistema de generación de visualizaciones que combina **Plotly** (gráficas interactivas web) y **Matplotlib** (gráficas estáticas para PDF) con detección automática del contexto de salida.
